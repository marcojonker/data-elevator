...
MigratorCmdInit.prototype.onRun = function(options, callback) {
    ...
    try{
        ...
        FileUtils.createDirectory(new CreateDirectory(migrationsDir, true));
        ...
        this.logger.info('>> Migrations initialized');
        return callback(null);
    } catch(error) {
        this.logger.info('>> Failed to initizalize migrations: ' + error.message);
