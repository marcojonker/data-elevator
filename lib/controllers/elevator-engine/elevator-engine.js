 ...
 * @param config
 * @param LevelController - custom level controller
 */
var _createLevelController = function(config, LevelController)  {
...
ElevatorEngine.move = function(config, direction, endIdentifier, logger, LevelController, callback) {
    ...
    //Create status handler
    try{
        levelController = _createLevelController(config, LevelController); 
    } catch(error) {
        return callback(error);
    }
