...
FileLevelController.prototype.saveCurrentLevel = function(level, callback) {
    ...
    try {
        ...
        return callback(Errors.systemError('Failed to write level file ' . config.levelFilePath, error));
    }
};
...
FileLevelController.prototype.retrieveCurrentLevel = function(callback) {
    ...
    try {
        ...
        return callback(Errors.systemError('Failed to read level file ' . config.levelFilePath, error));
    }
};
