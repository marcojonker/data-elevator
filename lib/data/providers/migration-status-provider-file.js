/**
 * MongoDbMigrationStatusProvider
 ...
 * Constructor
 */
var MongoDbMigrationStatusProvider = function(config) {
    this.database = null;
    
    MongoDbMigrationStatusProvider.super_.apply(this, arguments);
...
util.inherits(MongoDbMigrationStatusProvider, MigrationStatusProviderBase);

/**
 * Get open database connection
 * @param callback(error, database)
 */
MongoDbMigrationStatusProvider.prototype.getConnection = function(callback) {
    if(!this.database) {
 ...
 * @param callback(error, database)
 */
MongoDbMigrationStatusProvider.prototype.getMigrationsCollection = function(callback) {
    var self = this;
 ...
 */
MongoDbMigrationStatusProvider.prototype.saveStatus = function(migrationStatus, callback) {
 ...
 */
MongoDbMigrationStatusProvider.prototype.retrieveStatus = function(callback) {
    this.getMigrationsCollection(function(error, database, collection) {
        if(!error) {
...
module.exports = MongoDbMigrationStatusProvider;