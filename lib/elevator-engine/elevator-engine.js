 ...
 */
const _getFloors = function (config, level, floor, callback) {
  let floors = []
 ...
 */
const _moveElevator = function (config, floors, ascending, logger, levelController, callback) {
