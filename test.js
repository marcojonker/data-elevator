...
var commandTests = [
    ...
    { title: "ADD FLOOR",           command: { "command": "add", "workingDir": "./test-data-elevator" } },
    { title: "ADD FLOOR",           command: { "command": "add", "workingDir": "./test-data-elevator" } },
    { title: "MOVE UP TO TOP FLOOR",command: { "command": "move", "workingDir": "./test-data-elevator", "floor": "top" } },
    { title: "MOVE UP TO TOP FLOOR",command: { "command": "move", "workingDir": "./test-data-elevator", "floor": "ground" } },
